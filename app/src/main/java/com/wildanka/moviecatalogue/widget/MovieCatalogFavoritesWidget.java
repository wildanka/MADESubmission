 ...
 */
public class MovieCatalogFavoritesWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.wildanka.moviecatalogue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.wildanka.moviecatalogue.EXTRA_ITEM";
